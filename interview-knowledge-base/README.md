...
- `questions/` — каталог вопросов и ответов, разбитый по техническим направлениям. Каждый вопрос оформлен в виде карточки с метаданными (YAML frontmatter), кратким ответом (TL;DR), развернутым объяснением, частыми каверзными вопросами и ссылками на практические задачи.
...
- [Техники тест-дизайна и их примене��ие в автоматизации](questions/testing-theory/test-design-techniques.md)
...
1. Откройте нужную тему и читайте секции **Краткий ответ (TL;DR)**.
